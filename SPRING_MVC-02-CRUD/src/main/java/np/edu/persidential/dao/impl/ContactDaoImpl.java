...
public class ContactDaoImpl implements ContactDao {
  ...
  public void save(Contact contact) throws SQLException {
    final String QUERY =
        "INSERT INTO contacts (first_name, last_name, address, phone_number, email, employee_position) VALUES (?,?,?,?,?,?)";
    ...
    preparedStatement.setString(6, contact.getEmployeePosition());
  ...
  public void update(Contact contact) throws SQLException {
    final String QUERY =
        "UPDATE contacts set first_name = ?, last_name = ?, address = ?, phone_number = ?, email = ?, employee_position = ? WHERE id = ?";
    connection = connectionFactory.getConnection();
    preparedStatement = connection.prepareStatement(QUERY);
    preparedStatement.setString(1, contact.getFirstName());
    preparedStatement.setString(2, contact.getLastName());
  ...
  public List<Contact> findAll() throws SQLException {
    ...
    while (resultSet.next()) {
      ...
      contact.setEmployeePosition(resultSet.getString("employee_position"));
